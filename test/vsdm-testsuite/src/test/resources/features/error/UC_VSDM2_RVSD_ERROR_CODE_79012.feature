...
Funktionalität: Fehlerbehandlung VSDM 2.0
  ...
  Fehlerfall könnte z.B. ein PoPP-Token mit unbekannter IK zum Fachdienst VSDM 2.0 sein.
    ...
    Wenn das Primärsystem die VSD mit einer unbekannten IK-Nummer vom VSDM Ressource Server abfragt
    ...
    Beispiele:
      ...
      | "smcbCardImage.xml" | 1         | "egkCardData.json" | 2        | 400       | "VSDSERVICE_UNKNOWN_IK" |
